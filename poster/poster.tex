...
\setbeamertemplate{logo left}{\includegraphics[height=7em]{tartu_ylikool-logo_ja_v2rvid-cmyk-07_copy.png}}
\setbeamertemplate{logo right}{\includegraphics[height=5em]{ita_small-logo-eng.png}}
