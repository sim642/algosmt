...
(declare-const ivory Int)
(declare-const green Int)
(declare-const norwegian Int)
(declare-const ukrainian Int)
(declare-const englishman Int)
(declare-const spaniard Int)
(declare-const japanese Int)
(declare-const water Int)
(declare-const tea Int)
(declare-const milk Int)
(declare-const orangejuice Int)
(declare-const coffee Int)
(declare-const kools Int)
(declare-const chesterfield Int)
(declare-const oldgold Int)
(declare-const luckystrike Int)
(declare-const parliament Int)
(declare-const fox Int)
(declare-const horse Int)
(declare-const snails Int)
